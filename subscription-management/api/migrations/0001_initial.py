    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=10, unique=True, validators=[django.core.validators.RegexValidator(message='Phone number must be 10-digit long.', regex='^\\d{10}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.BigIntegerField()),
                ('deleted_at', models.BigIntegerField(blank=True, null=True)),
                ('currency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='api.currency')),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='subscription', to='api.invoice')),
